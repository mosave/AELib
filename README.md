...
## Пример простой прошивки смарт реле с использованием фреймворка
 ...
 * **btnVeryLongPressed()**: Обнаружено очень длинное (более 10с) нажатие кнопки. Сбрасывается при считывании
 ...
 Кроме того, на "10 быстрых нажатий" любой зарегистрированнуой кнопки можно навесить одно из предопределенных 
 ...
 * **\<RelayName\>/State**: "1" или "0", Текущее состояние реле (retained)
 
Топики, обрабатываемые модулем: 
 * **\<RelayName\>/State**, payload "1" или "0": задать текущее состояние реле
